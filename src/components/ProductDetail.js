...
import useDocumentTitle from '../hooks/useDocumentTitle'; // Importar el hook
...
function ProductDetail() {
  ...
  // La llamada al hook AHORA SÍ está después de la declaración de 'product'.
  ...
  const handleAddToCart = () => {
    ...
    // Reemplazamos el 'alert' por el 'showToast' global (si existe)
    if (window.showToast) {
      window.showToast(`${quantity} x ${product.nombre} añadido(s) al carrito.`, 'success');
    } else {
