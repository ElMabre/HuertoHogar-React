...
function AdminUsuarios() {
  ...
  const handleDelete = (id) => {
    // Replicando la confirmación del admin.js [cite: 2362-2363]
    if (window.confirm(`¿Estás seguro de que quieres eliminar el usuario ${id}?`)) {
      ...
      alert(`Usuario ${id} eliminado`); // [cite: 2364]
    }
  };
  ...
  return (
    <Container fluid>
      {/* Encabezado y botón "Nuevo Usuario" [cite: 4034-4035] */}
      ...
      {/* Tabla de Usuarios [cite: 4036-4040] */}
      ...
      {/* Modal para Agregar/Editar Usuario [cite: 4087-4098] */}
